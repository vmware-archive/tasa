...
MEDIA_ROOT = os.environ['DATA_FOLDER']+'/images/'
...
STATIC_ROOT = os.environ['DATA_FOLDER']+'/static/'
...
SECRET_KEY = 'caoc&_q3_o#gu@_f@ly@_4t82tfumzm9f^820%l91n#a=o!hm5'
...
INSTALLED_APPS = (
    ...
    #Include your personal Django Apps here
    'webserver.GPTopicDemo',
